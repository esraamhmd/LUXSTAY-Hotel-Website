...
export default function RoomsPageClient({ rooms = [] }) {
  ...
  return (
    <section className="bg-cream pb-20 pt-36">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <div className="sticky top-19 z-30 -mx-5 mb-10 flex flex-wrap gap-2 bg-cream/95 px-5 py-4 backdrop-blur lg:static lg:mx-0 lg:bg-transparent lg:px-0 lg:py-0">
          {roomFilters.map((f) => (
            <button
              key={f}
            ...
            >
              {f}
              {f !== "All Rooms" && (
                <span className="ml-1.5 text-xs text-ink/70">
